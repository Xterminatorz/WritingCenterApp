...
public class HandoutsExpandableListAdapter extends BaseExpandableListAdapter {

    private Context context;
    private List<String> expandableListTitle;
    private HashMap<String, List<Handout>> expandableListDetail;

    public HandoutsExpandableListAdapter(Context context, List<String> expandableListTitle,
